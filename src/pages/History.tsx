          ...
          filteredEntries.map((entry, index) => (
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {/* 感情 */}
                <div>
                  <h4 className="text-sm font-medium text-gray-700 mb-2">感情</h4>
                ...
                {/* 自動思考 */}
                <div>
                  <h4 className="text-sm font-medium text-gray-700 mb-2">自動思考</h4>
                  <p className="text-sm text-gray-600">
                    {entry.automaticThought.length > 60 
                      ? `${entry.automaticThought.substring(0, 60)}...` 
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                <div className="flex justify-between items-center">
                  <div className="text-sm text-gray-500">
                    感情変化: {entry.emotionChange}/10
                  </div>
                  <div className="text-xs text-gray-400">
                    作成日: {entry.createdAt.toLocaleDateString('ja-JP')}
                  </div>
                </div>
              </div>
            </motion.div>
